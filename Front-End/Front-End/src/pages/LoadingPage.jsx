    ...
    return (
        ...
        >
            ...
            <div class='flex space-x-2 justify-center items-center mb-5'>
                ...
                <div class='h-3 w-2 bg-sky-700 rounded-full animate-bounce [animation-delay:-0.3s]'></div>
                <div class='h-3 w-2 bg-sky-700 rounded-full animate-bounce [animation-delay:-0.15s]'></div>
                <div class='h-3 w-2 bg-sky-700 rounded-full animate-bounce'></div>
            </div>
            <p className="text-lg font-extrabold font-mono animate-pulse text-sky-800">
