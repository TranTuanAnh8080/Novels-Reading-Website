  ...
  return (
    <section className="bg-white rounded-lg shadow p-6 flex flex-col md:flex-row items-center gap-6">
      ...
      <div className="flex-1 space-y-3">
        <h2 className="text-lg font-bold">✨ Chào mừng đến với InkRealm</h2>
        ...
        <div className="flex space-x-3 mt-6">
          <Link to= "/RegisterPage" className="px-4 py-2 bg-[#2E5BFF] text-white rounded-full text-sm hover:bg-blue-700">
            Đăng ký ngay
          </Link>
          <button className="px-4 py-2 border border-[#2E5BFF] rounded-full text-sm text-[#2E5BFF] hover:bg-blue-50">
            Tìm hiểu thêm
          </button>
        </div>
      </div>
