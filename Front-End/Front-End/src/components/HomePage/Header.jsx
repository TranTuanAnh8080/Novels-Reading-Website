    ...
    <header className="bg-white text-gray-900 shadow-md sticky top-0 z-50
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-6 relative">
        ...
        <div className="flex-1 min-w-0">
          <div className="max-w-xl mx-auto flex items-center gap-2">
            <div className="relative w-full">
              ...
              />
              <Search 
                className="absolute right-3 top-2.5 h-5 w-5 text-gray-500 cursor-pointer hover:text-indigo-500" 
            ...
            <button 
                ...
                className="p-2 rounded-full bg-gray-100 border border-gray-300 hover:bg-indigo-50 hover:border-indigo-300 hover:text-indigo-600 transition-colors dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <Link to="/LoginPage">
            <button className="px-4 py-2 text-sm rounded-full border border-gray-300 hover:bg-gray-100 dark:border-gray-700 dark:hover:bg-gray-800 transition-colors">
              Đăng nhập
            </button>
          </Link>
          <Link to="/RegisterPage">
            <button className="px-4 py-2 text-sm rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:brightness-110 transition-all">
              Đăng ký
            </button>
          </Link>
        </div>
