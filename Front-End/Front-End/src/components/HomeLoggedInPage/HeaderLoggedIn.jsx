...
export default function HeaderLoggedIn() {
  ...
  // ✅ Nội dung hiển thị khi hover (như trang chưa đăng nhập)
  const contentMap = {
    about: {
      title: "Về Chúng Tôi",
      body: `
            ...
            >
              ...
              {hoveredItem === key && (
                <div
                  ...
                  shadow-xl rounded-xl p-4 border border-gray-700 z-50 animate-fadeIn backdrop-blur-sm"
                >
                  <h3 className="text-base font-semibold text-indigo-400 mb-1">
                    {contentMap[key].title}
                  </h3>
                  <p className="text-sm leading-relaxed text-gray-300 text-wrap whitespace-pre-line">
                    {contentMap[key].body}
                  </p>
                </div>
              )}
        ...
        <div className="flex items-center gap-4 flex-shrink-0">
          <Link to="/Profile">
            <img
              ...
              alt="user avatar"
              className="w-9 h-9 rounded-full border border-gray-700 cursor-pointer hover:opacity-80"
            />
          </Link>
